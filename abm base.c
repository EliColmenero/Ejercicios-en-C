...
int altaAlumno(eAlumno vec[], int tam); //devuelve si lo pudo cargar o no
...
int main()
{
    ...
    hardcodearAlumnos(lista, TAM, 9); //Le paso lista, tam y la cantidad de alumnos que quiero cargar
